...
class Geo3KToolGame(AbstractGame):
    ...
    **Feedback Format (matching verl's Geo3kTool):**
    ...
    def step(self, action: str) -> StepResult:
        ...
        observation = f"Current parsed answer={parsed_answer} reward={correctness_reward}"
    ...
    def _simple_match(self, solution_str: str) -> float:
        ...
        return self.REWARD_CORRECT if parsed_normalized == gt_normalized else self.REWARD_INCORRECT
